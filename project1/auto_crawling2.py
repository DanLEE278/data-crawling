...
def crawl_dataset(page):
    ...
    driver.get(f"https://eyefakes.com/gallery.php?page={page}&codename=vip")
...
if __name__ == "__main__":
    error_log = open("error_vip.txt", "w")
    counter = 0
    
    # for idx in tqdm(range(255,739,1)):
    for idx in tqdm(range(632,739,1)):
        ...
        for partial_url, name in zip(results, results2):
            ...
            fpath = f"./samples_vip/{str(counter).zfill(5)}_{new_str}.png"
            print(fpath)
