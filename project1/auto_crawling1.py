...
def crawl_dataset(page):
    ...
    driver.get(f"https://eyefakes.com/gallery.php?page={page}&codename=Members")
...
if __name__ == "__main__":
    error_log = open("error_member.txt", "w")
    counter = 0
    # for idx in tqdm(range(610,1233,1)):
    for idx in tqdm(range(1150,1233,1)):
        ...
        for partial_url, name in zip(results, results2):
            ...
            fpath = f"./samples_members/{str(counter).zfill(5)}_{new_str}.png"
            print(fpath)
